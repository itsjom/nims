...
class HaMaterialController extends Controller
{
    public function index()
    {
        $materials = HaMaterial::all();
        $procedures = Procedure::orderBy('name', 'asc')->get();
        return view('ha-materials.index', compact('materials', 'procedures'));
    }
    ...
    public function store(Request $request)
    {
        ...
        HaMaterial::create($data);

        return redirect()->route('ha-materials.index')->with('success', 'Equipment added successfully.');
    }
}
