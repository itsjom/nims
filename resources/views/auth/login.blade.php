        ...
        <div class="bg-white/80 backdrop-blur-xl rounded-3xl shadow-xl border border-white p-8">
            ...
            <form method="POST" action="{{ route('login.post') }}" class="space-y-5">
                ...
                <div>
                    ...
                    <div
                        class="flex items-center w-full bg-slate-50 border border-slate-200 rounded-xl focus-within:border-green-500 focus-within:ring-2 focus-within:ring-green-500/20 transition-all overflow-hidden relative">
                        <div class="pl-4 pr-2 flex items-center justify-center pointer-events-none">
                            <svg class="h-5 w-5 text-slate-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        <input id="password" type="password" name="password" required
                            class="flex-1 block w-full py-3 pr-2 pl-4 bg-transparent border-0 focus:ring-0 focus:outline-none text-slate-800 placeholder-slate-400 font-medium"
                            placeholder="••••••••">
                            
                        <button type="button" onclick="togglePasswordVisibility()" class="pr-4 pl-2 flex items-center justify-center text-slate-400 hover:text-slate-600 focus:outline-none transition-colors">
