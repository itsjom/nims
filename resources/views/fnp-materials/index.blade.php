...
@section('content')
    ...
    <div class="flex justify-between items-center mb-6">
        ...
        <button onclick="document.getElementById('addFnpModal').classList.remove('hidden')"
    ...
    <div id="addFnpModal"
        ...
        <div class="relative w-full max-w-md bg-white rounded-2xl shadow-xl overflow-hidden transform transition-all">
            <div class="px-6 py-4 border-b border-slate-100 flex justify-between items-center bg-slate-50/50">
                ...
                <button onclick="document.getElementById('addFnpModal').classList.add('hidden')"
            ...
            <form action="{{ route('fnp-materials.store') }}" method="POST" class="p-6">
                ...
                <div class="mt-8 flex justify-end gap-3">
                    <button type="button" onclick="document.getElementById('addFnpModal').classList.add('hidden')"
